...
<title>发信息</title>
	...
	<script type="text/javascript">
        $(function () {
			$.ajax({
				type:"get",
				url:"${pageContext.request.contextPath}/emp/others",
...
<form id="form2" name="form2" action="${pageContext.request.contextPath}/em/saveInfo" method="get">
