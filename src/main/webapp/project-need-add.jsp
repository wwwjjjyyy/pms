			...
			$.ajax({
				...
				success:function (msg) {
					$(msg).each(function (index,item) {
						var option = "<option>" + item.pname + "</option>"
						$("#analysisList").append(option);
                    })
                }
			})
        });
...
<form id="form2" name="form2" action="${pageContext.request.contextPath}/analysis/saveInfo" method="post">
