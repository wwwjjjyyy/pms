...
<link rel="stylesheet" type="text/css" href="skin/css/base.css">
	...
	<script type="text/javascript">
        $(function () {
			$.ajax({
				type:"get",
				url:"${pageContext.request.contextPath}/pos/list",
				success:function (msg) {
					$(msg).each(function (index,item) {
						var option = "<option value='"+item.id+"'>"+item.name+"</option>";
                    	$("#pos-list").append(option)
					})
                }
			})
        })
...
<tr >
	...
	<td id="role-list" align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
