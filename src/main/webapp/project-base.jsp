...
<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22" >
        ...
        <td>${pro.empcount}</td>
        <td>
            <fmt:formatDate value="${pro.starttime}" pattern="yyyy-MM-dd"/>
        </td>
        <td>
            <fmt:formatDate value="${pro.buildtime}" pattern="yyyy-MM-dd"/>
        </td>
        <td>
            <fmt:formatDate value="${pro.endtime}" pattern="yyyy-MM-dd"/>
        </td>
        <td>进行中</td>
