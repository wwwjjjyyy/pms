...
<li><a href='${pageContext.request.contextPath}/analysis/list' target='main'>需求分析管理</a> </li>
...
<li><a href='${pageContext.request.contextPath}/attr/list' target='main'>附件管理</a> </li>
</ul>
</dd>
</dl>
...
<li><a href='message-give.jsp' target='main'>消息推送</a> </li>
	...
	<li><a href='${pageContext.request.contextPath}/fatie.jsp' target='main'>发帖</a> </li>
</ul></dd></dl>
...
<li><a href='${pageContext.request.contextPath}/cust/getCustList' target='main'>客户信息</a> </li>
</ul></dd></dl>
