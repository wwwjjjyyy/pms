...
<link rel="stylesheet" type="text/css" href="skin/css/base.css">
	...
	<script type="text/javascript">
		...
		function parseLeader(cid) {
			$.ajax({
				type:"GET",
				url:"${pageContext.request.contextPath}/cust/info",
				data:{"cid":cid},
                success:function (msg) {
					$("#Leader").val(msg.companyperson);
                }
			})
        }
        function commit() {
...
<tr >
	...
	<td align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
		<select name="comname" id="custList" onchange="parseLeader(this.value)">
			<option>请选择...</option>
		</select>
	</td>
</tr>
<tr >
	...
	<td align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
		<input id="Leader" type="text" name="comper" readonly/>
	</td>
