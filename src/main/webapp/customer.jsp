        ...
        function exportExcel() {
            $.ajax({
                ...
                success:function (msg) {
                    if(msg.code == 200){
                        alert("成功");
                        window.location.href="${pageContext.request.contextPath}/cust/getCustList";
                    }else{
                        alert("失败");
                        window.location.href="${pageContext.request.contextPath}/cust/getCustList";
                    }
...
<c:forEach items="${list}" var="cust" varStatus="index">
    ...
    <tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22" >
        ...
        <td>
            <fmt:formatDate value="${cust.addtime}" pattern="yyyy-MM-dd"/>
        </td>
        <td>${cust.comphone}</td>
        <td><a href="${pageContext.request.contextPath}/cust/editor/${cust.id}">编辑</a> | <a href="${pageContext.request.contextPath}/cust/detail/${cust.id}">查看详情</a></td>
    </tr>
</c:forEach>
